...
import type { RequestOptions, RetryConfig } from "../../src/core/types.js"
...
describe("executeRequest timeout/abort precedence", () => {
  ...
  it("timeout firing first surfaces timeout, not cancelled", async () => {
    ...
    const retryConfig: RetryConfig = { retryOnStatus: [408, 429, 500], backoff: { baseDelayMs: 10, jitter: false } }
